...
[![GoDoc](https://godoc.org/github.com/quantcatxyz/go-binance?status.svg)](https://godoc.org/github.com/quantcatxyz/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/quantcatxyz/go-binance)](https://goreportcard.com/report/github.com/quantcatxyz/go-binance)
...
```shell
go get github.com/quantcatxyz/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/quantcatxyz/go-binance/v1
```
...
import (
    ...
    "github.com/quantcatxyz/go-binance/v2/futures" // optional package
    "github.com/quantcatxyz/go-binance/v2/delivery" // optional package
    "github.com/quantcatxyz/go-binance/v2/options" // optional package
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/quantcatxyz/go-binance) for full references.
